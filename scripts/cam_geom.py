...
def get_intrinsic_matrix(field_of_view_deg, image_width, image_height):
    ...
    cameraInfo = Info({
        "focalLengthX": 947.8956909179688, #1055.55615, # 1200.6831,947.3107299804688, 1905.49719        # focal length x
        "focalLengthY": 947.8956909179688, #1055.55615, # 1200.6831,         # focal length y
        "opticalCenterX": 633.8579711914062, # 638.1608, 633.8585205078125,       # optical center x
        "opticalCenterY": 352.96539306640625, #572.65509, # 738.8648,       # optical center y
        "cameraHeight": 1700, # 1879.8,  # camera height in `mm`
        "pitch": 0.0, #7.4654919, #26,           # rotation degree around x
...
class CameraGeometry(object):
    def __init__(self, height=1.62, yaw_deg=0, pitch_deg=-7, roll_deg=0, image_width=1920, image_height=1080, field_of_view_deg=60):
        # scalar constants
        self.height = height
